...
namespace project.roles
{
    ...
    public class rolController : controllerCommons<rolEntity, rolCreationDto, rolDto, rolQueryDto, object, string>
    {
        ...
        public rolController(RoleManager<rolEntity> rolManager, ApplicationDBContext contex, IMapper mapper, UserManager<userEntity> userManager) : base(contex, mapper)
        {
